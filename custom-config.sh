...
echo 'CONFIG_TARGET_ath79_generic_DEVICE_asus_rt-ac59u-v2=y' >> $BUILDROOT/.config
...
echo 'CONFIG_GETDNS_ENABLE_STUB_ONLY=y' >> $BUILDROOT/.config
...
echo 'CONFIG_PACKAGE_kmod-lp=y' >> $BUILDROOT/.config
...
echo 'CONFIG_PACKAGE_kmod-ppdev=y' >> $BUILDROOT/.config
